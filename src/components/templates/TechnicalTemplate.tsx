...
export default function TechnicalTemplate({ data }: { data: ResumeData }) {
  ...
  return (
    <div className="bg-[#0f172a] text-[#e2e8f0] p-12 min-h-[297mm] w-full mx-auto shadow-2xl print:shadow-none font-mono text-[11px] leading-relaxed">
      {/* Header */}
      ...
      <div className="technical-renderer">
        <ResumeMasterRenderer data={data} templateType="technical" />
      </div>
